...
browser.find_element_by_xpath("/html/body/div[1]/div[2]/div/div/div/form/div/a[2]").click()
time.sleep(1)

name = browser.find_element_by_id("id_base-name")
name.send_keys("IBMI")
time.sleep(1)

tax = browser.find_element_by_id("id_base-tax_number")
tax.send_keys("12345")
time.sleep(1)
