...
browser.get("http://127.0.0.1:8000/sa/permission-groups/new/") 
time.sleep(1)
browser.find_element_by_xpath("//*[@id='id_name']").send_keys('Admin')
browser.find_element_by_xpath("//*[@id='permissions-accordion']/div[1]/button[1]").click()
